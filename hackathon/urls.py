...
from .views import home, register, user_login, learner, instructor, courses, logout_view,learner_profile,update_learner_profile,instructor_profile,update_instructor_profile
